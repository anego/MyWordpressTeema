...
class BSWidgetCategory extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		<?php if ( $title ) ?>
		<?php echo $before_title . '<a data-toggle="collapse" data-parent="#accordion" href="#collapseCategory">' . $title . '</a>' . $after_title; ?>
		<?php
			echo '<div id="collapseCategory" class="panel-collapse collapse in">';
