...
'after_widget' => '</div>',
'before_title' => '<div class="page-header text-muted divider"><canvas class="dot3"></canvas>',
'after_title' => '</div>'
) );
...
function themename_customize_register($wp_customize) {
	// セクションを追加
	$wp_customize->add_section( 'projectlife_box_background_image', array(
		'title'		=> 'ボックス背景画像',
		'priority'	=> 100,
	) );

	// セクションの動作設定
	$wp_customize->add_setting( 'projectlife_box_background_image', array(
		'default'		=> '',
		'type'			=> 'option',
	...
	$wp_customize->add_control( new WP_Customize_Image_Control(
		...
		array(
			'label'		=> '画像',
			'section'	=> 'projectlife_box_background_image',
			'settings'	=> 'projectlife_box_background_image',
		)
	) );
